            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLinkSetting">
                    <a class="dropdown-item" href="{{ url('vendor/profile') }}">Profile Setting</a>
                    <a class="dropdown-item" href="{{ url('vendor/business') }}">Business Settings</a>
                    <a class="dropdown-item" href="{{ url('vendor/logout') }}">Logout</a>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div class="col-md-4">
            <div class="card card-user">
              ...
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    <img class="avatar border-gray" src="https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg?20200913095930" alt="...">
