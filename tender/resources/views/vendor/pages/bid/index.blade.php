...
<div class="wrapper">
    ...
    @includeIf('vendor.pages.layout.top-nav')
    @includeIf('vendor.pages.layout.fixed-sidebar')
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of all Bids available</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td> {{ $bids->tender->tender_title }} </td>
                    <td> {{ $bids->bid_title }} </td>
                    <td> {{ $bids->bid_offer }} </td>
                    <td> {{ $bids->timeframe }} </td>
                    <td> {{ $bids->bid_attachment }} </td>
                    <td> {{ $bids->bid_status == 1 ? 'Active' : 'Inactive' }} </td>
                    <td><a class="btn btn-info btn-sm" href="{{ url('admin/bid/edit/'.$bids->id) }}"> Edit </a></td>
                  </tr>
                  @endforeach
                </table>
              </div>
