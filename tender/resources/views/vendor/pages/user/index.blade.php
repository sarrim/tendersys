          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of all Users available</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td> {{ $user->username }} </td>
                    <td> {{ $user->email }} </td>
                    <td> {{ $user->user_type == 2 ? 'Supplier' : 'Customer' }} </td>
                    <td> {{ $user->profile_picture }} </td>
                    <td> {{ $user->user_status == 1 ? 'Active' : 'Inactive' }} </td>
                    <td><a class="btn btn-info btn-sm" href="{{ url('admin/user/edit/'.$user->id) }}"> Edit </a></td>
                  </tr>
                  @endforeach
                </table>
              </div>
