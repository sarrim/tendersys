...
<!-- Mirrored from themezhub.net/live-workplex/workplex/home-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:05 GMT -->
<head>
		<meta charset="utf-8" />
    ...
    <body>
       ...
       <div class="preloader"></div>
        ...
        <div id="main-wrapper">
			...
			<!-- ======================= Home Banner ======================== -->
			<div class="home-banner margin-bottom-0" style="background:#00ab46 url(assets/img/banner-5.jpg) no-repeat;" data-overlay="5">
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="position-relative text-center">
								<a href="job-search-v1.html" class="btn btn-md text-light rounded theme-bg">Explore More Jobs<i class="lni lni-arrow-right-circle ml-2"></i></a>
							</div>
						</div>
					</div>
						...
						<div class="col-xl-10 col-lg-11 col-md-12 col-sm-12">
							<div class="row justify-content-center">
								...
								<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
									<div class="cats-wrap text-left">
										<a href="job-search-v1.html" class="cats-box rounded bg-white d-flex align-items-center px-2 py-3">
											<div class="text-center"><img src="assets/img/c-11.png" class="img-fluid" width="55" alt=""></div>
											<div class="cats-box-caption px-2">
												<h4 class="fs-md mb-0 ft-medium">Web Designing</h4>
												<span class="text-muted">302 Jobs</span>
											</div>
								...
								<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
									<div class="cats-wrap text-left">
										<a href="job-search-v1.html" class="cats-box rounded bg-white d-flex align-items-center px-2 py-3">
											<div class="text-center"><img src="assets/img/c-3.png" class="img-fluid" width="55" alt=""></div>
											<div class="cats-box-caption px-2">
												<h4 class="fs-md mb-0 ft-medium">Web Designing</h4>
												<span class="text-muted">302 Jobs</span>
											</div>
...
<!-- Mirrored from themezhub.net/live-workplex/workplex/home-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:07 GMT -->
</html>