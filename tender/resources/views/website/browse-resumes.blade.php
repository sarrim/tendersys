...
<!-- Mirrored from themezhub.net/live-workplex/workplex/browse-resumes.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:15 GMT -->
<head>
		<meta charset="utf-8" />
							...
							<div class="row align-items-center">
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="job_grid border rounded ">
										<div class="position-absolute ab-left"><button type="button" class="p-3 border circle d-flex align-items-center justify-content-center bg-white text-gray"><i class="lni lni-heart-filled position-absolute snackbar-wishlist"></i></button></div>
										<div class="job_grid_thumbmb-2 text-center pt-4 px-3 mb-2">
											<a href="candidate-detail.html" class="d-inline-flex text-center m-auto circle border p-2"><img src="assets/img/t-9.png" class="img-fluid circle" width="70" alt="" /></a>
										</div>
										<div class="job_grid_caption text-center pb-3 px-3">
											<h4 class="mb-0 ft-medium medium"><a href="candidate-detail.html" class="text-dark fs-md">John K. Surber</a></h4>
											<div class="jbl_location"><i class="lni lni-map-marker mr-1"></i><span>San Francisco</span></div>
...
<!-- Mirrored from themezhub.net/live-workplex/workplex/browse-resumes.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:16 GMT -->
</html>