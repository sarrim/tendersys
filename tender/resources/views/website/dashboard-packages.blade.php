...
<!-- Mirrored from themezhub.net/live-workplex/workplex/dashboard-packages.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:40 GMT -->
<head>
		<meta charset="utf-8" />
					...
					<div class="dashboard-nav">
						<div class="dashboard-inner">
							<ul data-submenu-title="Main Navigation">
								...
								<li class="active"><a href="dashboard-packages.html"><i class="lni lni-mastercard mr-2"></i>Packages</a></li>
					...
					<div class="dashboard-tlbar d-block mb-5">
						<div class="row">
							<div class="colxl-12 col-lg-12 col-md-12">
								<h1 class="ft-medium">Package</h1>
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										<li class="breadcrumb-item text-muted"><a href="#">Home</a></li>
										<li class="breadcrumb-item text-muted"><a href="#">Dashboard</a></li>
										<li class="breadcrumb-item"><a href="#" class="theme-cl">Package</a></li>
									</ol>
								</nav>
							</div>
						</div>
