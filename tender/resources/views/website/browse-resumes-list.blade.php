...
<!-- Mirrored from themezhub.net/live-workplex/workplex/browse-resumes-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:43 GMT -->
<head>
		<meta charset="utf-8" />
										...
										<div class="col-xl-9 col-lg-8 col-md-7 col-sm-12">
											<div class="filter_wraps elspo_wrap d-flex align-items-center justify-content-end">
												...
												<div class="single_fitres">
													<a href="browse-resumes.html" class="simple-button mr-1"><i class="ti-layout-grid2"></i></a>
													<a href="browse-resumes-list.html" class="simple-button active theme-cl"><i class="ti-view-list"></i></a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="job_grid d-block border rounded px-3 pt-3 pb-2">
										<div class="jb-list01-flex d-flex align-items-start justify-content-start">
											<div class="jb-list01-thumb">
												<img src="assets/img/t-1.png" class="img-fluid circle" width="90" alt="" />
											</div>
