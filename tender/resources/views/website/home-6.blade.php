...
<!-- Mirrored from themezhub.net/live-workplex/workplex/home-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:10 GMT -->
<head>
		<meta charset="utf-8" />
					...
					<div class="row align-items-center justify-content-between">
						<div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12">
							<div class="banner_caption text-left mb-4">
								<div class="d-block mb-2"><span class="px-3 py-1 medium bg-light-danger text-danger rounded">Get Trending jobs</span></div>
								<h1 class="banner_title ft-bold mb-1">Explore More Than<br><span class="text-danger">7840+</span> Jobs</h1>
							...
							<form class="bg-white rounded p-1">
								<div class="row no-gutters">
									...
									<div class="col-xl-2 col-lg-3 col-md-3 col-sm-12 col-12">
										<div class="form-group mb-0 position-relative">
											<button class="btn full-width custom-height-lg bg-danger text-white fs-md" type="button">Find Job</button>
										</div>
									</div>
								</div>
							</form>
					...
					<div class="row justify-content-center">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="sec_title position-relative text-center mb-5">
								...
								<h2 class="ft-bold">Recent Active <span class="text-danger">Listed jobs</span></h2>
							</div>
						</div>
					</div>
					...
					<div class="row align-items-center">
							...
							<div class="jbr-wrap text-left border rounded">
								<div class="cats-box mlb-res rounded bg-white d-flex align-items-center justify-content-between px-3 py-3">
									<div class="cats-box rounded bg-white d-flex align-items-center">
										<div class="text-center"><img src="assets/img/c-16.png" class="img-fluid" width="55" alt=""></div>
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="jbr-wrap text-left border rounded">
								<div class="cats-box mlb-res rounded bg-white d-flex align-items-center justify-content-between px-3 py-3">
									<div class="cats-box rounded bg-white d-flex align-items-center">
										<div class="text-center"><img src="assets/img/c-15.png" class="img-fluid" width="55" alt=""></div>
										<div class="cats-box-caption px-2">
											<h4 class="fs-md mb-0 ft-medium">Fresher UI/UX Designer (3 Year Exp.)</h4>
											<div class="d-block mb-2 position-relative">
												<span class="text-muted medium"><i class="lni lni-map-marker mr-1"></i>Liverpool, London</span>
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="jbr-wrap text-left border rounded">
								<div class="cats-box mlb-res rounded bg-white d-flex align-items-center justify-content-between px-3 py-3">
									<div class="cats-box rounded bg-white d-flex align-items-center">
										<div class="text-center"><img src="assets/img/c-14.png" class="img-fluid" width="55" alt=""></div>
										<div class="cats-box-caption px-2">
											<h4 class="fs-md mb-0 ft-medium">Fresher UI/UX Designer (3 Year Exp.)</h4>
											<div class="d-block mb-2 position-relative">
												<span class="text-muted medium"><i class="lni lni-map-marker mr-1"></i>Liverpool, London</span>
					...
					<div class="row justify-content-center">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="position-relative text-center">
								<a href="job-search-v1.html" class="btn btn-md bg-dark rounded text-light">Explore More Jobs<i class="lni lni-arrow-right-circle ml-2"></i></a>
							</div>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="row align-items-center">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-laptop-phone fs-lg text-danger"></i></div>
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-cloud fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-shopify fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-construction fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-phone-set fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-sthethoscope fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-money-protection fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-diamond fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-briefcase fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-graduation fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-mastercard fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
							<div class="cats-wrap text-center">
								<a href="job-search-v1.html" class="cats-box d-block rounded bg-white px-2 py-4">
									<div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 bg-light-danger circle"><i class="lni lni-gallery fs-lg text-danger"></i></div>
									<div class="cats-box-caption">
					...
					<div class="row justify-content-center">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="position-relative text-center">
								<a href="job-search-v1.html" class="btn btn-md bg-danger rounded text-light hover-theme">Browse All Categories<i class="lni lni-arrow-right-circle ml-2"></i></a>
							</div>
						</div>
					</div>
			...
			<section class="space min">
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="sec_title position-relative text-center mb-5">
								<h6 class="text-muted mb-0">Top Candidates</h6>
								<h2 class="ft-bold">Hire Top <span class="text-danger">Candidates</span></h2>
							</div>
						</div>
					</div>
					...
					<div class="row align-items-center">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job_grid border rounded ">
								...
								<div class="job_grid_thumbmb-2 text-center pt-4 px-3 mb-2">
									<a href="candidate-detail.html" class="d-inline-flex text-center m-auto circle border p-2"><img src="assets/img/t-8.png" class="img-fluid circle" width="70" alt="" /></a>
								</div>
								<div class="job_grid_caption text-center pb-3 px-3">
									<h4 class="mb-0 ft-medium medium"><a href="candidate-detail.html" class="text-dark fs-md">John K. Surber</a></h4>
								...
								<div class="job_grid_footer pb-4 px-3">
									<div class="df-1 text-dark ft-medium col-12 mt-3"><a href="candidate-detail.html" class="btn gray apply-btn rounded full-width">View Candidate<i class="lni lni-arrow-right-circle ml-1"></i></a></div>
								</div>
							</div>
						</div>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job_grid border rounded ">
								<div class="position-absolute ab-left"><button type="button" class="p-3 border circle d-flex align-items-center justify-content-center bg-white text-gray"><i class="lni lni-heart-filled position-absolute snackbar-wishlist"></i></button></div>
								<div class="job_grid_thumbmb-2 text-center pt-4 px-3 mb-2">
									<a href="candidate-detail.html" class="d-inline-flex text-center m-auto circle border p-2"><img src="assets/img/t-7.png" class="img-fluid circle" width="70" alt="" /></a>
								</div>
								<div class="job_grid_caption text-center pb-3 px-3">
									<h4 class="mb-0 ft-medium medium"><a href="candidate-detail.html" class="text-dark fs-md">Loretta E. Reyes</a></h4>
									<div class="jbl_location"><i class="lni lni-map-marker mr-1"></i><span>San Francisco</span></div>
								</div>
								<div class="job_grid_footer px-3">
									<ul class="p-0 skills_tag text-center">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job_grid border rounded ">
								<div class="position-absolute ab-left"><button type="button" class="p-3 border circle d-flex align-items-center justify-content-center bg-white text-gray"><i class="lni lni-heart-filled position-absolute snackbar-wishlist"></i></button></div>
								<div class="job_grid_thumbmb-2 text-center pt-4 px-3 mb-2">
									<a href="candidate-detail.html" class="d-inline-flex text-center m-auto circle border p-2"><img src="assets/img/t-6.png" class="img-fluid circle" width="70" alt="" /></a>
								</div>
								<div class="job_grid_caption text-center pb-3 px-3">
									<h4 class="mb-0 ft-medium medium"><a href="candidate-detail.html" class="text-dark fs-md">Adam B. Johnston</a></h4>
									<div class="jbl_location"><i class="lni lni-map-marker mr-1"></i><span>San Francisco</span></div>
								</div>
								<div class="job_grid_footer px-3">
									<ul class="p-0 skills_tag text-center">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job_grid border rounded ">
								<div class="position-absolute ab-left"><button type="button" class="p-3 border circle d-flex align-items-center justify-content-center bg-white text-gray"><i class="lni lni-heart-filled position-absolute snackbar-wishlist"></i></button></div>
								<div class="job_grid_thumbmb-2 text-center pt-4 px-3 mb-2">
									<a href="candidate-detail.html" class="d-inline-flex text-center m-auto circle border p-2"><img src="assets/img/t-5.png" class="img-fluid circle" width="70" alt="" /></a>
								</div>
								<div class="job_grid_caption text-center pb-3 px-3">
									<h4 class="mb-0 ft-medium medium"><a href="candidate-detail.html" class="text-dark fs-md">Jessica G. Leininger</a></h4>
									<div class="jbl_location"><i class="lni lni-map-marker mr-1"></i><span>San Francisco</span></div>
								</div>
								<div class="job_grid_footer px-3">
									<ul class="p-0 skills_tag text-center">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job_grid border rounded ">
								<div class="position-absolute ab-left"><button type="button" class="p-3 border circle d-flex align-items-center justify-content-center bg-white text-gray"><i class="lni lni-heart-filled position-absolute snackbar-wishlist"></i></button></div>
								<div class="job_grid_thumbmb-2 text-center pt-4 px-3 mb-2">
									<a href="candidate-detail.html" class="d-inline-flex text-center m-auto circle border p-2"><img src="assets/img/t-4.png" class="img-fluid circle" width="70" alt="" /></a>
								</div>
								<div class="job_grid_caption text-center pb-3 px-3">
									<h4 class="mb-0 ft-medium medium"><a href="candidate-detail.html" class="text-dark fs-md">Charles T. Gerena</a></h4>
									<div class="jbl_location"><i class="lni lni-map-marker mr-1"></i><span>San Francisco</span></div>
								</div>
								<div class="job_grid_footer px-3">
									<ul class="p-0 skills_tag text-center">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job_grid border rounded ">
								<div class="position-absolute ab-left"><button type="button" class="p-3 border circle d-flex align-items-center justify-content-center bg-white text-gray"><i class="lni lni-heart-filled position-absolute snackbar-wishlist"></i></button></div>
								<div class="job_grid_thumbmb-2 text-center pt-4 px-3 mb-2">
									<a href="candidate-detail.html" class="d-inline-flex text-center m-auto circle border p-2"><img src="assets/img/t-3.png" class="img-fluid circle" width="70" alt="" /></a>
								</div>
								<div class="job_grid_caption text-center pb-3 px-3">
									<h4 class="mb-0 ft-medium medium"><a href="candidate-detail.html" class="text-dark fs-md">Julie D. Morales</a></h4>
									<div class="jbl_location"><i class="lni lni-map-marker mr-1"></i><span>San Francisco</span></div>
								</div>
								<div class="job_grid_footer px-3">
									<ul class="p-0 skills_tag text-center">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job_grid border rounded ">
								<div class="position-absolute ab-left"><button type="button" class="p-3 border circle d-flex align-items-center justify-content-center bg-white text-gray"><i class="lni lni-heart-filled position-absolute snackbar-wishlist"></i></button></div>
								<div class="job_grid_thumbmb-2 text-center pt-4 px-3 mb-2">
									<a href="candidate-detail.html" class="d-inline-flex text-center m-auto circle border p-2"><img src="assets/img/t-2.png" class="img-fluid circle" width="70" alt="" /></a>
								</div>
								<div class="job_grid_caption text-center pb-3 px-3">
									<h4 class="mb-0 ft-medium medium"><a href="candidate-detail.html" class="text-dark fs-md">Samantha D. Hebert</a></h4>
									<div class="jbl_location"><i class="lni lni-map-marker mr-1"></i><span>San Francisco</span></div>
								</div>
								<div class="job_grid_footer px-3">
									<ul class="p-0 skills_tag text-center">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job_grid border rounded ">
								<div class="position-absolute ab-left"><button type="button" class="p-3 border circle d-flex align-items-center justify-content-center bg-white text-gray"><i class="lni lni-heart-filled position-absolute snackbar-wishlist"></i></button></div>
								<div class="job_grid_thumbmb-2 text-center pt-4 px-3 mb-2">
									<a href="candidate-detail.html" class="d-inline-flex text-center m-auto circle border p-2"><img src="assets/img/t-1.png" class="img-fluid circle" width="70" alt="" /></a>
								</div>
								<div class="job_grid_caption text-center pb-3 px-3">
									<h4 class="mb-0 ft-medium medium"><a href="candidate-detail.html" class="text-dark fs-md">Patricia B. North</a></h4>
									<div class="jbl_location"><i class="lni lni-map-marker mr-1"></i><span>San Francisco</span></div>
								</div>
								<div class="job_grid_footer px-3">
									<ul class="p-0 skills_tag text-center">
					...
					<div class="row justify-content-center">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="sec_title position-relative text-center mb-4">
								...
								<h2 class="ft-bold">Pickup New <span class="text-danger">Updates</span></h2>
							</div>
						</div>
					</div>
...
<!-- Mirrored from themezhub.net/live-workplex/workplex/home-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:11 GMT -->
</html>