...
<!-- Mirrored from themezhub.net/live-workplex/workplex/employer-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:22 GMT -->
<head>
		<meta charset="utf-8" />
							...
							<div class="d-block border rounded mfliud-bot mb-4">
								<div class="cdt_author px-2 pt-5 pb-4">
									<div class="dash_auth_thumb rounded p-1 border d-inline-flex mx-auto mb-3">
										<img src="assets/img/c-1.png" class="img-fluid" width="100" alt="" />
									</div>
									<div class="dash_caption mb-4">
										<h4 class="fs-lg ft-medium mb-0 lh-1">Themezhub Limited</h4>
								...
								<div class="cdt_caps">
									<div class="job_grid_footer pb-3 px-3 d-flex align-items-center justify-content-between">
										...
										<div class="df-1 text-muted"><i class="lni lni-laptop-phone mr-1"></i>IT & Software</div>
									</div>	
									<div class="job_grid_footer px-3 d-flex align-items-center justify-content-between">
										...
										<div class="df-1 text-muted"><i class="lni lni-calendar mr-1"></i>Build 2010</div>
									</div>
								</div>
						...
						<div class="col-12 col-md-12 col-lg-8 col-xl-8">
							...
							<div class="row align-items-start">
								...
								<div class="abt-cdt d-block full-width mb-4">
									<h4 class="ft-medium mb-1 fs-md">About ThemezHub</h4>
