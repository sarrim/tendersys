...
<!-- Mirrored from themezhub.net/live-workplex/workplex/single-job-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 06:14:15 GMT -->
<head>
		<meta charset="utf-8" />
					...
					<div class="row">
						...
						<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
							...
							<div class="d-block mb-4">
								<a href="javascript:void(0);" class="btn btn-md gray ft-medium rounded"><i class="ti-back-left mr-1"></i>Back</a>
							</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
							<div class="mt-5 rounded shadow p-4 box-static z-index-1 bg-white">
								...
								<div class="drt-block-caption">
									<div class="drt-soc-caption text-center mb-3">
										<h4 class="ft-medium mb-0 fs-md">Themezhub Infotech</h4>
										<span><i class="lni lni-map-marker mr-1"></i>Denver, USA</span>
									</div>
								...
								<div class="row">
									<div class="col-6">
										<div class="empl-box rounded bg-white d-flex justify-content-center px-4 py-3 shadow mb-3">
											<div class="text-center"><img src="assets/img/l-2.png" class="img-fluid" alt=""></div>
										</div>
									</div>
									<div class="col-6">
										<div class="empl-box rounded bg-white d-flex justify-content-center px-4 py-3 shadow mb-3">
											<div class="text-center"><img src="assets/img/l-3.png" class="img-fluid" alt=""></div>
										</div>
									</div>
									<div class="col-6">
										<div class="empl-box rounded bg-white d-flex justify-content-center px-4 py-3 shadow mb-3">
											<div class="text-center"><img src="assets/img/l-4.png" class="img-fluid" alt=""></div>
										</div>
									</div>
									<div class="col-6">
										<div class="empl-box rounded bg-white d-flex justify-content-center px-4 py-3 shadow mb-3">
											<div class="text-center"><img src="assets/img/l-5.png" class="img-fluid" alt=""></div>
										</div>
									</div>
									<div class="col-6">
										<div class="empl-box rounded bg-white d-flex justify-content-center px-4 py-3 shadow mb-3">
											<div class="text-center"><img src="assets/img/l-6.png" class="img-fluid" alt=""></div>
										</div>
									</div>
									<div class="col-6">
										<div class="empl-box rounded bg-white d-flex justify-content-center px-4 py-3 shadow mb-3">
											<div class="text-center"><img src="assets/img/l-7.png" class="img-fluid" alt=""></div>
										</div>
									</div>
								</div>
							</div>
